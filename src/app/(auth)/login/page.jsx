...
import { authClient } from '@/lib/auth-client'; // আপনার প্রজেক্টের auth-client পাথ অনুযায়ী চেক করে নিন
...
const SignInPage = () => {
    ...
    const handelSignIn = async (e) => {
        ...
        // authClient এর মাধ্যমে ইমেইল লগইন রিকোয়েস্ট পাঠানো
    ...
    return (
        <div className='min-h-screen bg-black text-white flex justify-center items-center p-4 relative overflow-hidden'>
            ...
            <div className='w-full max-w-md p-6 sm:p-10 bg-white/5 backdrop-blur-xl border border-white/10 shadow-2xl rounded-3xl relative z-10 animate-in fade-in zoom-in duration-300'>
                ...
                <Form className="flex flex-col gap-4" onSubmit={handelSignIn}>
                    ...
                    <div className="flex flex-col gap-3 mt-4"> 
                        <Button 
                            type="submit" 
                            isLoading={isLoading}
                            className='w-full bg-blue-600 hover:bg-blue-500 text-white py-2.5 rounded-xl font-medium shadow-lg shadow-blue-600/10 transition-all duration-200'
                        >
